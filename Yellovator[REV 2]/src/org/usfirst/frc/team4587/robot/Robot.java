...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		liftertotes.displayElevator();
		Collection.displayIntake();
		scorertotes.displayDeployer();
	}

	/**
	 * s T cvbvhis function is called periodically during test mode
	 */
